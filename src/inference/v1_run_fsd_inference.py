...
class SelfDrivingCarSimulator:
    def __init__(self, steering_model:SteeringAnglePredictor, segmetation_model:ImageSegmentation, data_path:str, img_path:str):
        self.steering_model = steering_model
        self.segmentation_model = segmetation_model
        self.data_path = data_path
        self.img = cv2.imread(img_path,0)
        self.smoothed_angle = 0.0
        self.cols, self.rows,_ = self.img.shape
...
if __name__ == "__main__":
    ...
    simulator = SelfDrivingCarSimulator(steering_predictor, image_segmentation, "data/driving_dataset", "data/steering_wheel_image.png")
